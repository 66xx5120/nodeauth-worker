const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/web3-vendor-CyOsJY-H.js","assets/pdf-utils-HZTV32cA.js","assets/compression-utils-CXh1ITwj.js","assets/element-plus-Ca9klJWt.js","assets/vue-core-Daban9YF.js","assets/element-plus-Dh61In7b.css","assets/features-BwnnnvjY.js","assets/basic-DfAGJm4h.js","assets/index-c3qQILgi.js","assets/qr-utils-BC7NLEos.js","assets/w3m-modal-uoqjuFPu.js"])))=>i.map(i=>d[i]);
import { _ as Ut, __tla as __tla_0 } from "./pdf-utils-HZTV32cA.js";
import { f as Yn, e as At, G as As, U as Ns, a as Nn, h as Nt, b as bs, t as bn, N as Is, __tla as __tla_1 } from "./web3-vendor-CyOsJY-H.js";
    ...
    async function Un() {
        if (!Jt) {
            const { createPublicClient: e, http: t, defineChain: n } = await Ut(async ()=>{
                const { createPublicClient: s, http: r, defineChain: a } = await import("./web3-vendor-CyOsJY-H.js").then(async (m)=>{
                    await m.__tla;
                    return m;
                }).then((o)=>o.c);
                return {
...
`;
        ...
        async initialize(t) {
            if (this.initializeProjectSettings(t), this.initControllers(t), await this.initChainAdapters(), this.sendInitializeEvent(t), t.features?.headless && !te.hasInjectedConnectors() && A.prefetch({
                ...
                const { ReownAuthentication: n } = await Ut(async ()=>{
                    const { ReownAuthentication: r } = await import("./features-BwnnnvjY.js");
                    return {
    ...
    class ws extends Sa {
        ...
        async injectModalUi() {
            if (!Gn && E.isClient()) {
                if (await Ut(()=>import("./basic-DfAGJm4h.js"), __vite__mapDeps([7,8,1,2,9,3,4,5,0])), await Ut(()=>import("./w3m-modal-uoqjuFPu.js"), __vite__mapDeps([10,8,1,2,0,3,4,5])), !document.querySelector("w3m-modal")) {

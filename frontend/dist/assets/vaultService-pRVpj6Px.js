const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-CVKpA-OL.js","assets/pdf-utils-CLgdGVwQ.js","assets/compression-utils-CXh1ITwj.js","assets/vue-core-Daban9YF.js","assets/element-plus-CVRB8fAt.js","assets/element-plus-Dh61In7b.css","assets/simplewebauthn-3qpiAaRi.js","assets/tanstack-query-C-OQsQoR.js","assets/index-CKCC89YU.css"])))=>i.map(i=>d[i]);
import { _ as q, __tla as __tla_0 } from "./pdf-utils-CLgdGVwQ.js";
import { n as F, o as H, l as z, r as y, b as G, p as w, u as K, s as J, g as W, q as _, a as N, __tla as __tla_1 } from "./index-CVKpA-OL.js";
        ...
        async getTrashList () {
            ...
            try {
                const { useLayoutStore: r } = await q(async ()=>{
                    const { useLayoutStore: o } = await import("./index-CVKpA-OL.js").then(async (m)=>{
                        await m.__tla;
                        return m;
                    }).then((i)=>i.x);
                    return {
                        ...
                        if (!h?.success) {
                            ...
                            if (b) {
                                ...
                                const { useOfflineStore: S } = await q(async ()=>{
                                    const { useOfflineStore: g } = await import("./index-CVKpA-OL.js").then(async (m)=>{
                                        await m.__tla;
                                        return m;
                                    }).then((T)=>T.y);
                                    return {

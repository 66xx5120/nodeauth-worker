...
import { _ as o, __tla as __tla_0 } from "./pdf-utils-HZTV32cA.js";
let a, i;
let __tla = Promise.all([
    ...
    a = {
        ...
        UTILITIES: [
            {
                name: "qrcode",
                loader: ()=>o(()=>import("./qr-utils-BC7NLEos.js").then((r)=>r.b), __vite__mapDeps([0,1,2,3])),
                probes: [
                    "qrcode",
                    "qrparser",
                    "vaultservice",
            ...
            {
                name: "jsqr",
                loader: ()=>o(()=>import("./qr-utils-BC7NLEos.js").then((r)=>r.j), __vite__mapDeps([0,1,2,3])),
                probes: [
                    "jsqr",
                    "qrparser",
                    "datamigration"

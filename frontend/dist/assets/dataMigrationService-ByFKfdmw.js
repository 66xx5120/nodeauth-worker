const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/qr-utils-Dc88R2Tw.js","assets/element-plus-WhZlrFJq.js","assets/vue-core-Brk0ioAg.js","assets/element-plus-Dh61In7b.css","assets/index-Dyh55lTL.js","assets/pdf-utils-BwD264iA.js","assets/compression-utils-CXh1ITwj.js","assets/simplewebauthn-3qpiAaRi.js","assets/tanstack-query-DHczWKty.js","assets/index-BSpd7Htm.css"])))=>i.map(i=>d[i]);
import { _ as ne, __tla as __tla_0 } from "./pdf-utils-BwD264iA.js";
import { n as pe, O as _e, p as V, b as ee, v as fe, __tla as __tla_1 } from "./vaultService-BQipjw8Z.js";
...
import { l as ue, d as Ue, e as De, __tla as __tla_2 } from "./index-Dyh55lTL.js";
import { a as Re } from "./qr-utils-Dc88R2Tw.js";
import { a as he } from "./argon2-browser-BiDCPJHC.js";
import { l as be, __tla as __tla_3 } from "./resourceRegistry-DAA6-3RG.js";
import { argon2id as Ce } from "./hash-wasm-Dup_VHWH.js";
import { unzipSync as Ne } from "./compression-utils-CXh1ITwj.js";
import "./vue-core-Brk0ioAg.js";
import "./element-plus-WhZlrFJq.js";
...
`)[0].toLowerCase() : "";
    ...
    const Ve = {
        ...
        async exportToGoogleAuth (n) {
            ...
            const i = Math.floor(Math.random() * 2147483647), l = await ne(()=>import("./qr-utils-Dc88R2Tw.js").then((w)=>w.b), __vite__mapDeps([0,1,2,3])), f = [];
            function g(w, y) {
...
`;
    ...
    const oe = {
        ...
        async exportToHtml (n) {
            const r = await ne(()=>import("./qr-utils-Dc88R2Tw.js").then((t)=>t.b), __vite__mapDeps([0,1,2,3])), e = [];
            e.push(`
      <!DOCTYPE html>
      <html>
      <head>
        ...
        async fetchAllVault () {
            ...
            try {
                const { useAppLockStore: e } = await ne(async ()=>{
                    const { useAppLockStore: l } = await import("./index-Dyh55lTL.js").then(async (m)=>{
                        await m.__tla;
                        return m;
                    }).then((f)=>f.R);
                    return {
                    ...
                    const { unmaskSecretFront: l } = await import("./index-Dyh55lTL.js").then(async (m)=>{
                        await m.__tla;
                        return m;
                    }).then((f)=>f.Q);
                    return {
